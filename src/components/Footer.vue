  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-wrap md:text-left text-center order-first">
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        <h2 class="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">DRIVERS</h2>
      ...
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <p class="text-gray-500 text-sm mt-2 md:text-left text-center">Want all the gossip on the upcoming F1 season?<br/>
  ...
  <div class="bg-gray-100">
    <div class="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
      <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
        👋
        <span class="ml-3 text-xl">Russ Forster</span>
      </a>
       <p class="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">This is a demo project using the <a href="https://ergast.com/">ergast f1 api</a>, VueJS and TailWind.
        
      </p>
     
      <span class="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">

        <a href="https://github.com/rforster-dev" target="_blank" class="ml-3 text-gray-500">
        ...
        <a href="https://www.linkedin.com/in/rcforster/" target="_blank" class="ml-3 text-gray-500">
            <span class="sr-only">View my linkedin profile</span>
