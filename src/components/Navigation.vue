<template>
    <nav id="primary-nav" class="md:ml-auto flex flex-wrap items-center text-base justify-center">
        <ul class="grid grid-cols-4 gap-y-4 gap-x-8">
            <li v-for="navigationLink in navigationLinks" :key="navigationLink.id">
