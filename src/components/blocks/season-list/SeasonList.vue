    ...
    <div class="-my-8 divide-y-2 divide-gray-100">
      <div v-for="race in allRaces2021" :key="race.key" class="race-item py-8 flex flex-wrap md:flex-nowrap">
        <div class="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
          ...
          <a :href="`https://www.google.com/maps/place/${race.Circuit.Location.lat},${race.Circuit.Location.long}`" target="_blank" class="race-gmap-link text-indigo-500 inline-flex items-center mt-4">Google maps
            <svg class="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
              <path d="M5 12h14"></path>
              <path d="M12 5l7 7-7 7"></path>
            </svg>
          </a>
          <a :href="`${race.Circuit.url}`" target="_blank" class="race-wikilink text-indigo-500 inline-flex items-center mt-4">Wikipedia entry
            <svg class="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
              <path d="M5 12h14"></path>
              <path d="M12 5l7 7-7 7"></path>
            </svg>
