      ...
      <div class="container px-5 py-24 mx-auto">
         <div class="flex flex-wrap w-full mb-20">
            ...
            <p class="hero-cta-text lg:w-1/2 w-full leading-relaxed text-gray-500">
               ...
               <a class="hero-cta-link text-indigo-500 inline-flex items-center mt-4" href="/all-drivers.html">
         ...
         <div class="flex flex-wrap -m-4">
            ...
            <div class="xl:w-1/4 md:w-1/2 p-4">
               <div class="">
                  ...
                  <a href="/season-list.html" class="text-indigo-500 inline-flex items-center mt-4">
